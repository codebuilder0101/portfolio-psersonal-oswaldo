...
export function ShareBar({ title, slug }: { title: string; slug: string }) {
  ...
  const url =
    typeof window !== "undefined"
      ...
      : `https://oswaldosmarrelli.com/articulos/${slug}`;
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 border-t border-border pt-6 mt-12">
      <span className="text-sm font-medium text-foreground mr-1">Compartir:</span>
      {items.map((i) => (
        <a
          key={i.label}
          href={i.href}

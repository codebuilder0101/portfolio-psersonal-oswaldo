  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 w-full bg-cream/95 backdrop-blur-sm border-b border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 h-20 flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-display font-bold text-xl md:text-2xl text-ink tracking-tight", children: "Oswaldo Smarrelli" }),
...
function SiteFooter() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-ink text-white/80 py-10 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto text-center space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-brand-teal hover:underline underline-offset-4", children: "Legal" }),
      " ",
      "y",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-brand-teal hover:underline underline-offset-4", children: "Política de Privacidad" })
    ] })
  ] }) });
}
export {

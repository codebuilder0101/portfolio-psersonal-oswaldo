...
import { N as NewsletterBlock, p as portrait } from "./oswaldo-portrait-3o1rNaiM.mjs";
import { c as Route$2 } from "./router-CRc2_FoN.mjs";
import "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { A as ArrowLeft, a as ArrowRight, j as Linkedin, C as Check, L as Link2 } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "max-w-2xl mx-auto px-6 pt-12 md:pt-16 pb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/articulos", className: "inline-flex items-center gap-2 text-sm font-medium text-brand-teal hover:text-brand-teal/75 transition-colors mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-6 pt-10 prose-editorial", children: article.body.map((block, i) => {
        ...
        if (block.type === "image") return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: block.text, alt: "", className: "w-full rounded-xl my-2", loading: "lazy" }, i);
        return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: block.text }, i);
      }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-6 mt-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5 items-start bg-card border border-border rounded-2xl p-6 md:p-7 shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: portrait, alt: "Oswaldo Smarrelli", className: "size-16 md:size-20 object-cover rounded-full flex-shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/sobre-mi", className: "inline-flex items-center gap-1.5 mt-3 text-sm font-medium text-brand-teal hover:text-brand-teal/75 transition-colors", children: [
      ...
      related.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-6xl mx-auto px-6 py-16 md:py-20 mt-8 border-t border-border", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: related.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/articulos/$slug", params: {
          slug: a.slug
        }, className: "group flex flex-col bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all", children: [

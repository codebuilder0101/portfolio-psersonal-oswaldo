...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DdnJFYBn.mjs");
...
const manifest = {
  "713c2d46e1bc9cba4ef43dcaf8386594ee2f7c6f8c94bb4b8feae4ce5b937fe9": {
    functionName: "sendContactMessage_createServerFn_handler",
    importer: () => import("./contact-ClyMW91j.mjs")
  },
  "fdfa8495d6093eac94c3dfc913fb5983fa499612e7aaf15f367760bef891f7d9": {
    functionName: "subscribeNewsletter_createServerFn_handler",
    importer: () => import("./newsletter-Dhzuo-RO.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Drg4k5g4.mjs").then((n) => n.r),
    import("./start-VoZarT38.mjs"),

...
import { a as ArrowRight, I as Instagram, M as Mail, A as ArrowLeft, X, g as Menu, b as ChevronDown, c as ChevronLeft, d as ChevronRight, U as User, P as Phone, F as Facebook, f as Linkedin, e as Clock, C as Check, L as Link2 } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-BKN3TxoP.css";
const Toaster = ({ ...props }) => {
...
function Gallery({ images }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 md:gap-4", children: shown.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => setIndex(i),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pointer-events-none absolute inset-0 bg-ink/0 group-hover:bg-ink/10 transition-colors" })
        ]
      },
      src
    )) }),
    images.length > PREVIEW_COUNT && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
...
const __vite_glob_0_33 = "/assets/image-background-D_PlxifE.jpeg";
...
const __vite_glob_0_37 = "/assets/photo-2-Dw3AJwQr.jpeg";
...
const modules = /* @__PURE__ */ Object.assign({
  ...
  "../assets/image-background.jpeg": __vite_glob_0_33,
...
const portrait$1 = "/assets/photo-2-Dw3AJwQr.jpeg";
...
function SobreMi() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-cream", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative md:h-[calc(100vh-5rem)] min-h-[30rem] overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: portrait$1,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/80 via-black/35 to-transparent md:bg-gradient-to-r md:from-black/90 md:via-black/55 md:to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-full flex items-end md:items-center justify-start px-6 md:px-12 lg:px-20 py-12 md:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xl text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-3xl md:text-4xl lg:text-5xl leading-[1.05] tracking-tight mb-8 text-balance drop-shadow-sm", children: "¿QUIÉN ES OSWALDO SMARRELLI TORREALBA?" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-md mx-auto", children: "Frases, ideas y reflexiones en @elpoderdelasfrases" }),
...
function ArticlePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "max-w-2xl mx-auto px-6 pt-12 md:pt-16 pb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to: "/articulos",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "border-border" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-6 pt-10 prose-editorial", children: [
